<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="ProductWebAssignment.Product" %>
...
<body>
    <form id="form1" runat="server" draggable="true">
        ...
        <br />
        <br />
        <asp:Button ID="btnSave" runat="server" Height="29px" OnClick="btnSave_Click" Style="margin-left: 6px" Text="Save" Width="70px" BackColor="#00FFCC" />
        &nbsp;&nbsp;&nbsp;
    ...
    <asp:Button ID="btnUpdate" runat="server" Height="27px" OnClick="btnUpdate_Click" Style="margin-left: 6px" Text="Update" Width="77px" BackColor="#FFFF99" />
        &nbsp;&nbsp;
    <asp:Button ID="btnDelete" runat="server" Height="25px" OnClick="btnDelete_Click" Style="margin-left: 6px" Text="Delete" Width="87px" BackColor="#FF66CC" BorderColor="#FF9900" />
