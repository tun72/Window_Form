<%@ Page Title="" Language="C#" MasterPageFile="~/employeer/Employee.master" AutoEventWireup="true" CodeFile="EditJobs.aspx.cs" Inherits="employeer_EditJobs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label ID="Label16" runat="server" Text="Edit Your Jobs Information" Font-Bold="True" Font-Size="X-Large" ForeColor="Red"></asp:Label>
    <br />
    <br />
    ...
    <table cellpadding="10" cellspacing="5" class="auto-style1">
        ...
        <tr>
            ...
            <td>
                ...
                <br />
                <asp:Calendar ID="job_calender" runat="server" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#663399" Height="200px" ShowGridLines="True" Width="220px" OnSelectionChanged="job_calender_SelectionChanged" >
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btn_update" runat="server" Font-Bold="True" Font-Size="X-Large" Height="45px" Text="Update" Width="159px" OnClick="btn_update_Click"  />
            </td>
