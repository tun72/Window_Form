...
namespace JobPortal.Employee
{
    public partial class JobList : System.Web.UI.Page
    {
        ...
        private void ShowJob()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as  [Sr.No], JobId, Title, NoOfPost, Qulification as Qualification , Experience, LastDateToApply,  Country, State, CreateDate from Jobs  where EmployeeId = '" + Session["EmployeeId"] + "'";
