                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4">
                        ...
                        <div class="job-category-listing mb-50 pb-0">
                            ...
                            <div class="single-listing">
                                ...
                                <asp:DropDownList ID="ddlCategory" runat="server" CssClass="form-control w-100 select-job-items2"
                                ...
                                <asp:DropDownList ID="ddlCountry" runat="server" CssClass="form-control w-100 select-job-items2"
                                    AutoPostBack="true" DataSourceID="SqlDataSource1" AppendDataBoundItems="True"
                            ...
                            <div class="single-listing">
                                ...
                                <div class="mb-1">
                                    ...
                                    <asp:LinkButton ID="lbFilter" runat="server" Width="100%" CssClass="btn btn-sm" OnClick="lbFilter_Click">Filter</asp:LinkButton>

                                </div>

                                <div class="mb-4">
                                    <asp:LinkButton ID="lbReset_btn" runat="server" Text="Reset" CssClass="btn btn-sm" Width="100%" OnClick="lbReset_btn_Click">Reset</asp:LinkButton>
                                                ...
                                                <div class="job-items">
                                                    ...
                                                    <div class="job-tittle job-tittle2">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><%# Eval("CompanyName").ToString().Length > 12 ? Eval("CompanyName").ToString().Substring(0, 12) + "..." : Eval("CompanyName")  %></li>
